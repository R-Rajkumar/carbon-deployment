...
import org.wso2.carbon.protobuf.constants.ProtobufConstants;
...
public class ProtobufRegistryActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) {
        ...
        // load ProtobufServer configurations from protobuf-server xml
        ...
        if (serverConfig.isSSLEnabled()) {
            ...
            String keystorePath = carbonConfig.getFirstProperty(ProtobufConstants.KEYSTORE_PATH);
            String keystorePassword = carbonConfig.getFirstProperty(ProtobufConstants.KEYSTORE_PASSWORD);
            String truststorePath = carbonConfig.getFirstProperty(ProtobufConstants.TRUSTSTORE_PATH);
            String truststorePassword =
                    carbonConfig.getFirstProperty(ProtobufConstants.TRUSTSTORE_PASSWORD);
